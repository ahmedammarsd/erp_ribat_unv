...
<div class="side-menu">
      ...
      //  $username1 = $_POST["username"];
        ...
        elseif($report_type === "exp"){
           ...
           if(mysqli_num_rows($display_data_from_exp) == 0){
            echo "<script>alert('No Reports')</script>";
           }
           else{
        ...
        echo "Total Expenses:" . $total_exp . "<br>";
    }
    ...
    elseif($report_type === "loans"){
       ...
       if(mysqli_num_rows($display_data_from_loans) == 0){
        echo "<script>alert('No Reports')</script>";
       }
       else{
...
elseif($report_type === "mustahqat"){
   ...
   if(mysqli_num_rows($display_data_from_mustahqat) == 0){
    echo "<script>alert('No Reports')</script>";
   }
   else{
...
echo "</table>" ;
    echo "<br>";
//-------------------------------------------------------------------------
if(mysqli_num_rows($display_data_from_loans) == 0 && mysqli_num_rows($display_data_from_exp) == 0 && mysqli_num_rows($display_data_from_mustahqat) == 0 && mysqli_num_rows($display_data_fees_std) == 0){
    echo "<script>alert('No Reports')</script>";
   }
   else{
$display_total_from_exp = mysqli_query($connection , "select sum(value_exp) AS total_exp from expenses where date_of_exp='$date_now'");
