    ...
    <div class="side-menu">
        ...
        <ul>
            <a href="../statics/statics.php">
                <li class="active"><img src="../../../icons/statc1.png" alt="" width="40px" height="40px">Reports</li>
            </a>
        ...
        <div class="content">
            <div class="row">
                <div class="cards">
                    <div class="card col-lg-4 col-md-6 col-xs-12">
                        ...
                        <div class="icon-case">
                            <img src="../../../icons/drr.png" alt="" srcset="" width="70px" height="70px">
                        </div>
                        <div>
                    ...
                    <div class="card col-lg-4 col-md-6 col-xs-12">
                        ...
                        <div class="icon-case">
                            <img src="../../../icons/qdr.png" alt="" srcset="" width="70px" height="70px">
                        </div>
                        <div>
                    ...
                    <div class="card col-lg-4 col-md-6 col-xs-12">
                        ...
                        <div class="icon-case">
                            <img src="../../../icons/pr.png" alt="" srcset="" width="70px" height="70px">
                        </div>
                        <div>
            ...
            <div class="cards bssa ">
                ...
                <div class="card col-lg-4 col-md-6 col-xs-12">
                    ...
                    <div class="icon-case">
                        <img src="../../../icons/ppp.png" alt="" srcset="" width="70px" height="70px">
                    </div>
                    <div>
                ...
                <div class="card col-lg-4 col-md-6 col-xs-12">
                    ...
                    <div class="icon-case">
                        <img src="../../../icons/ss.png" alt="" srcset="" width="70px" height="70px">
                    </div>
                    <div>
