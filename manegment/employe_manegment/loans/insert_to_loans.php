...
<body>
    <div class="side-menu">
        ...
        <ul>
            ...
            <a href="../tetchers/add_tetchers/add_tetcher.php">
                <li><img src="../../../icons/thh.png" alt="" width="40px" height="40px">Add Tetcher</li>
            </a>
            <a href="../workers/add_workers/add_worker.php">
                <li><img src="../../../icons/wok1.png" alt="" width="40px" height="40px">Add Worker</li>
            </a>
            <a href="../expenses/expenses.php">
                <li><img src="../../../icons/Expenses.png" alt="" width="40px" height="40px">Expenses</li>
            </a>
            <a href="../loans/loans.php">
                <li class="active"><img src="../../../icons/loans.png" alt="" width="40px" height="40px">loans</li>
            </a>
            <a href="../mustahqat/add_mustahq.php">
                <li><img src="../../../icons/mustahq.png" alt="" width="40px" height="40px">mustahq</li>
            </a>
            <a href="../salary/salary.php">
            ...
            <form action="" method="post">
                <div class="row">
                    <div class="form-group col-lg-4 col-md-6 col-xs-12">
                        ...
                        <input type="text" name="name" value="<?php if ($employeid) {
                                                                    echo $inp_name;
                                                                }
                                                                if ($tetcherid) {
                                                                    echo $inp_name;
                                                                ...
                                                                if ($workerid) {
                                                                    echo $inp_name;
                                                                } ?>" id="" class="form-control" redonly>
                    </div>
                    <div class="form-group col-lg-4 col-md-6 col-xs-12">
                        <label for="" class="lead">Jop Type</label>
                        <input type="text" name="jop" id="" value="<?php if ($employeid) {
                                                                        echo $inp_jop;
                                                                    }
                                                                    if ($tetcherid) {
                                                                        echo "tetcher";
                    ...
                    <div class="form-group col-lg-4 col-md-6 col-xs-12">
                        ...
                        <input type="text" name="phonenumber" value="<?php if ($employeid) {
                                                                            echo $inp_phone;
                                                                        }
                                                                        if ($tetcherid) {
                                                                            echo $inp_phone;
                                                                        ...
                                                                        if ($workerid) {
                                                                            echo $inp_phone;
                                                                        } ?>" class="form-control" id="" redonly>
                    </div>
                    <div class="form-group col-lg-4 col-md-6 col-xs-12">
                        <label for="" class="lead">maximun Loan</label>
                        <input type="text" name="bigloans" id="" value="<?php if ($employeid) {
                                                                            echo $big_value_loans;
                                                                        }
                                                                        if ($tetcherid) {
                                                                            echo $big_value_loans;
