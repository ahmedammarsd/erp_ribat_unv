...
<head>
    ...
    <link rel="stylesheet" href="../../../../css/manegment/edit_emp.css">
 ...
 <div class="info-emp">
    <table class="table table-striped table-hover">
        <tr>
            ...
            <th>EMAIL</th>
            <th>ADDRESS</th>
            <th>ACADEMIC QUALIFICATIONS1</th>
            <th>ACADEMIC QUALIFICATIONS2</th>
            <th>ACADEMIC QUALIFICATIONS3</th>
            <th>SALARY</th>
            <th>USERNAME</th>
            <th>DATE OF ADD</th>
            <th>OPERATION</th>
        ...
        <?php
        $display_data = mysqli_query($connection , "select * from tetchers where del = 'no' ");
            ...
            if($display_data){
                ...
                while( $row = mysqli_fetch_array($display_data)){
                    ...
                    $email = $row['email'];
                    $adsress = $row['address'];
                    $academicqualification1 = $row['academic_qualification1'];
                    $academicqualification2 = $row['academic_qualification2'];
                    $academicqualification3 = $row['academic_qualification3'];
                    $salary = $row['salary'];
                   ...
                   echo "<td>".$email."</td>";
                   echo "<td>".$adsress."</td>";
                   echo "<td>".$academicqualification1."</td>";
                   echo "<td>".$academicqualification2."</td>";
                   echo "<td>".$academicqualification3."</td>";
                   echo "<td>".$salary."</td>";
                   echo "<td>".$username."</td>";
