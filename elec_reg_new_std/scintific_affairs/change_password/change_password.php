...
$display_data = mysqli_query($connection, "select * from scientific_affairs_employes where full_name='$full_name'");
$row = mysqli_fetch_array($display_data);
$name_user = $row["full_name"];

$display_password = mysqli_query($connection, "select password from scientific_affairs_employes where full_name='$full_name'");
...
if (isset($_POST["change"])) {
    ...
    if ($old_password != $password) {
        ...
        if ($new_password != $confirm_password) {
            ...
            $update_password = mysqli_query($connection, "update scientific_affairs_employes set password='$new_password' where full_name='$full_name'");
            if ($update_password) {
...
$name_user_admin =  $_SESSION["user_admin_scientific_affairs"];
if ($name_user_admin != "") {
