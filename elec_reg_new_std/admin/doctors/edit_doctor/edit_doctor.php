...
<head>
    ...
    <link rel="stylesheet" href="../../../../css/manegment/admin/edit_doctor.css?v=<?php echo time();?>">
    <title>edit information doctor</title>
</head>
<body>
<div class="side-menu">
...
<h2><img src="../../../../icons/da.png" alt="" width="50px" height="50px">Scientific Affairs</h2>
 ...
 <div class="info-emp">
    <table class="table table-striped table-hover">
        ...
        <?php
        $display_data = mysqli_query($connection , "select * from medical_exam_doctors where del = 'no' ");
            ...
            if($display_data){
                ...
                while( $row = mysqli_fetch_array($display_data)){
                   ...
                   echo "<td><a href='display_for_editd.php?updateid=".$id."'><button  class='btn btn-primary'><img src='../../../../icons/u2.png' width='17px' height='20px'></button></a>
                             <a href='display_for_deleted.php?delid=".$id."'><button class='btn btn-danger'><img src='../../../../icons/d.png' width='17px' height='20px'></button></a></td>";
                   echo "<tr>";
                }
            }
            ?>
