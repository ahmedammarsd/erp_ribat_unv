...
if(isset($_POST["ser"])){
    ...
    $display_data = mysqli_query($connection , "select id,form_number,name_std,college,type_certificate_unv,department from new_std_form_info where review ='good' && college='$college' && type_certificate_unv = '$type_certificate_unv'  && optic= 'none' && year='$year' ");
    if(mysqli_num_rows($display_data) == 0){
        ...
        // لو الالمتغير الفوق دا صحيح سوف يتم عرض البيانات
            while( $row = mysqli_fetch_array($display_data)){
               ...
               echo "<td><a href='insert_the_info_std_optics.php?std_id=".$id."'><button  class='btn btn-primary'>كشف البصريات</button></a>";               echo "<tr>";
            }
        }
...
//     </tr>
//      ";
//       $display_data = mysqli_query($connection , "select id,form_number,name_std,college,type_certificate_unv,department from new_std_form_info where review ='good' and type_certificate_unv = 'دبلوم' and optic= 'none' and year='$year' ");
...
//                  echo "<td><a href='insert_the_info_std_optics.php?std_id=".$id."'><button  class='btn btn-primary'>كشف البصريات</button></a>";
//                  echo "<tr>";
//               }
//           }
