...
if(isset($_POST["ser"])){
  ...
  echo "
   ...
   ";
    $display_data = mysqli_query($connection , "select id,form_number,name_std,college,type_certificate_unv,department from new_std_form_info where review ='good' and type_certificate_unv = 'بكلاريوس' and optic= 'none' and year='$year' ");
