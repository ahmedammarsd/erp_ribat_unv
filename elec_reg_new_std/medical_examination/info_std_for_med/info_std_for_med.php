...
<head>
    ...
    <link rel="stylesheet" href="../../../css/manegment/medical_examination/info_std_for_med.css?v=<?php echo time();?>">
...
<div class="side-menu">
        ...
        <ul>
            ...
            <a href="../info_std_for_med/info_std_for_med.php"><li class="active"><img src="../../../icons/stdifo1.png" alt="" width="40px" height="40px">Students Information</li></a>
        </ul>
        </div>
    <div class="container">
    <div class="header">
