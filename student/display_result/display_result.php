...
<body>
    <div class="side-menu">
        ...
        <ul>
            <a href="../display_result/display_result.php">
                <li class="active"><img src="../../icons/re.png" alt="" width="40px" height="40px">Result</li>
            </a>
            <a href="../elec_reg/elec_reg.php">
                <li><img src="../../icons/reg.png" alt="" width="40px" height="40px">Register</li>
            </a>
        </ul>
    </div>
    <div class="container">
        ...
        <div class="form">
            <form action="" method="post">
                <div class="row">
                    ...
                    <div class="form-group col-lg-6 col-md-6 col-xs-6 my-5">
            ...
            <div>
                ...
                if (isset($_POST["result"])) {
                    ...
                    if (mysqli_num_rows($display_subject_and_degree) == 0) {
                        echo "<div class='alert alert-danger'>Sorry The Result Has Not Been Announced Yet</div>";
                    } else {
            ...
            <tr class='table-dark'>
              ...
              <th>Degree</th>
                ...
                ";
                        ...
                        echo "<div class='alert alert-primary'> Semester Average :" . round($SGPA, 2) . "</div>";
